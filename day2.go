...
//will retrun the count of valid passwords
func validPassword(pwrds []string) (int, error) {
	var min int
	var max int
	var err error
	var wrdcount = 0
	...
	for _, p := range pwrds {
		...
		//tmp[0] "1-2" min and max
		//tmp[2] "n:" required character
		...
		//get the required character have to ignore the ":"
		key := tmp[2][0]
